...
export class DiceStageController {
  ...
  reset() {
    ...
    this.flowToken += 1;
    this.roundIndex = 0;
    this.el.gameRoot.classList.remove('is-rolling', 'is-landed', 'show-action', 'show-final', 'dice-animation-active', 'dice-animation-ready', 'dice-animation-preview', 'is-building-house', 'is-house-built');
